...
# module references:
# bram_addr_mapper, bram_addr_mapper
...
proc create_root_design { parentCell } {
  ...
  # Create instance: bram_addr_mapper_0, and set properties
  set block_name bram_addr_mapper
  set block_cell_name bram_addr_mapper_0
  if { [catch {set bram_addr_mapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bram_addr_mapper_0 eq "" } {
  ...
  set block_name bram_addr_mapper
  set block_cell_name bram_addr_mapper_1
  if { [catch {set bram_addr_mapper_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bram_addr_mapper_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.n_addr_bits {1} \
 ] $bram_addr_mapper_1
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTB [get_bd_intf_pins axi_bram_ctrl_1/BRAM_PORTB] [get_bd_intf_pins axi_bram_ctrl_1_bram/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins axi_smc/M03_AXI] [get_bd_intf_pins nn_inference_0/s_axi_AXI_CPU]
  ...
  connect_bd_net -net bram_addr_mapper_0_addr_out [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins bram_addr_mapper_0/addr_out]
  connect_bd_net -net bram_addr_mapper_0_rst_out [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins bram_addr_mapper_0/rst_out]
  connect_bd_net -net bram_addr_mapper_0_wr_out [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins bram_addr_mapper_0/wr_out]
  connect_bd_net -net bram_addr_mapper_1_addr_out [get_bd_pins axi_bram_ctrl_1_bram/addrb] [get_bd_pins bram_addr_mapper_1/addr_out]
  connect_bd_net -net bram_addr_mapper_1_rst_out [get_bd_pins axi_bram_ctrl_1_bram/rstb] [get_bd_pins bram_addr_mapper_1/rst_out]
  connect_bd_net -net bram_addr_mapper_1_wr_out [get_bd_pins axi_bram_ctrl_1_bram/web] [get_bd_pins bram_addr_mapper_1/wr_out]
  connect_bd_net -net nn_inference_0_input_img_address0 [get_bd_pins bram_addr_mapper_0/addr_in] [get_bd_pins nn_inference_0/input_img_address0]
  connect_bd_net -net nn_inference_0_input_img_ce0 [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins nn_inference_0/input_img_ce0]
  connect_bd_net -net nn_inference_0_interrupt [get_bd_pins nn_inference_0/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net nn_inference_0_output_r_address0 [get_bd_pins bram_addr_mapper_1/addr_in] [get_bd_pins nn_inference_0/output_r_address0]
  connect_bd_net -net nn_inference_0_output_r_ce0 [get_bd_pins axi_bram_ctrl_1_bram/enb] [get_bd_pins nn_inference_0/output_r_ce0]
  connect_bd_net -net nn_inference_0_output_r_d0 [get_bd_pins axi_bram_ctrl_1_bram/dinb] [get_bd_pins nn_inference_0/output_r_d0]
  connect_bd_net -net nn_inference_0_output_r_we0 [get_bd_pins bram_addr_mapper_1/wr_in] [get_bd_pins nn_inference_0/output_r_we0]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins bram_addr_mapper_0/n_rst_in] [get_bd_pins bram_addr_mapper_1/n_rst_in] [get_bd_pins nn_inference_0/ap_rst_n] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins bram_addr_mapper_0/wr_in] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1_bram/clkb] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins nn_inference_0/ap_clk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs nn_inference_0/s_axi_AXI_CPU/Reg] -force
